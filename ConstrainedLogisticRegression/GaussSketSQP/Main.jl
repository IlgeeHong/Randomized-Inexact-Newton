...
cd("/Users/ilgeehong/Desktop/SQPwithSketching/ConstrainedLogisticRegression/GaussSketSQP")
# read problem
...
function main()
    ...
    if Aug.verbose
        ...
        for i=1:decom
            path = string("../Solution/GaussSketSQP", i, ".mat")
            Result = GaussSketR[(i-1)*NumProb+1:i*NumProb]
            write_matfile(path; Result)
        end
        path = string("../Solution/GaussSketSQP", decom+1, ".mat")
